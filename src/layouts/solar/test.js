...
function KnoxSolarData() {
  ...
  style={{
    display: 'flex',
    flexDirection: 'column',
    marginTop: screenWidth < 804 ? 20 : 40,
    marginBottom: 20,
  ...
  <View
    ...
    <View
      style={{
        ...
        borderColor: '#e2e8f0',
        borderRadius: 12,
         height: screenWidth < 804 ? 140 : 180,
      }}>
      <View style={{
        display: 'flex',
        flexDirection: 'row',
      ...
      <Text
        style={{
          fontSize: screenWidth < 804 ? 18 : 22,
          fontFamily: 'Poppins-Bold',
          color: '#1B3C55',
          marginBottom: 6,
        }}>
    ...
    <View
      ...
      <Text
        style={{
          fontSize: screenWidth < 804 ? 10 : 11,
          fontFamily: 'Poppins-Medium',
          color: '#64748b',
          marginBottom: 6,
        }}>
        {`${(solarData['knox/inverter_1/battery_capacity'] ?? '0%').replace(/\s+/g, '')}`}
      </Text>
      <View
        style={{
